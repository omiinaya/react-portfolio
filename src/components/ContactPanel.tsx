...
const ContactPanel: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="contact-panel-content"
        style={{ gridTemplateColumns: "3fr auto 1fr" }}
      >
            ...
            <div className="social-links-vertical">
              {profile.sections.profiles.items.map((profileItem) => (
                <a
                  ...
                  onClick={() =>
                    handleSocialClick(profileItem.network, profileItem.url.href)
                  }
                >
              ...
              <a
                ...
                onClick={() =>
                  handleSocialClick("Email", `mailto:${profile.basics.email}`)
                }
              >
                <div className="social-icon-wrapper">
                  <EmailIcon />
